...
func allocauto(ptxt *obj.Prog) {
	...
	for ll := Curfn.Func.Dcl; ll != nil; ll = ll.Next {
		...
		if Thearch.Thechar == '5' || Thearch.Thechar == '7' || Thearch.Thechar == '9' || Thearch.Thechar == 'z' {
...
func Cgen_checknil(n *Node) {
	...
	if ((Thearch.Thechar == '5' || Thearch.Thechar == '7' || Thearch.Thechar == '9' || Thearch.Thechar == 'z') && n.Op != OREGISTER) || !n.Addable || n.Op == OLITERAL {
		var reg Node
