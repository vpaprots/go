...
TEXT runtime·casuintptr(SB), NOSPLIT, $-8-25
	BR	runtime·cas64(SB)
...
TEXT runtime·atomicstoreuintptr(SB), NOSPLIT, $-8-16
...
TEXT runtime·xadduintptr(SB), NOSPLIT, $-8-24
...
TEXT runtime·xchgp1(SB), NOSPLIT, $-8-24
	BR	runtime·xchg64(SB)

TEXT runtime·xchguintptr(SB), NOSPLIT, $-8-24
	BR	runtime·xchg64(SB)

TEXT runtime·procyield(SB),NOSPLIT,$0-0
	RET

TEXT runtime·atomicstorep1(SB), NOSPLIT, $-8-16
	BR	runtime·atomicstore64(SB)
...
tail:
	SUB	$1, R5
	EXRL	$runtime·eqstring_clc(SB), R5
	BEQ	equal
	MOVB	R0, ret+32(FP)
	RET
equal:
...
TEXT runtime·eqstring_clc(SB),NOSPLIT,$0-0
	CLC	$1, 0(R3), 0(R4)
	RET

TEXT runtime·bytesequal_clc(SB),NOSPLIT,$0-0
	CLC	$1, 0(R3), 0(R4)
	RET
...
tail:
	SUB	$1, R5
	EXRL	$runtime·bytesequal_clc(SB), R5
	BEQ	equal
	MOVB	R0, ret+48(FP)
	RET
loop:
